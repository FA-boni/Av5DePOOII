...
CREATE TABLE `passageiros` (
  ...
  `acesso` enum('administrador','usuário','motorista') DEFAULT NULL,
  UNIQUE KEY `cpf` (`cpf`)
...
INSERT INTO `passageiros` VALUES ('000.000.000-00','Luiz Augusto','12345','administrador');
...
-- Dump completed on 2022-03-25 19:11:00
